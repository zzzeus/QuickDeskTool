...
namespace QuickDeskTool.Tool
{
    class EverythingHelper
    {
        ...
        public static List<SearchItem> getFilesByName(string pattern)
        {
            //var list =new List<string>();
            //Everything_SetSearchW(name);
            ...
            //{
            //    long date_modified;
            //    var filename=Everything_GetResultFileName(i);
            //    Everything_GetResultDateModified(i, out date_modified);

            //    // add it to the list box				
            //    //listBox1.Items.Insert((int)i, date_modified.ToString() + " " + Everything_GetResultFileName(i));
            //    list.Add(Everything_GetResultFileName(i));
            //}
            //return list;
            ...
            for (i = 0; i < Everything_GetNumResults(); i++)
            {
                ...
                list.Add(new SearchItem(buf.ToString() ,size));
            }
            return list;
        }
    }
